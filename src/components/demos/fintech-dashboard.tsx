...
const transactions = [
  { id: "TXN-001", to: "Stripe Inc.", amount: "-$2,450.00", status: "completed", date: "Jan 31, 2026" },
  { id: "TXN-002", to: "AWS Services", amount: "-$1,200.00", status: "completed", date: "Jan 30, 2026" },
  { id: "TXN-003", to: "Client Payment", amount: "+$8,500.00", status: "completed", date: "Jan 29, 2026" },
  { id: "TXN-004", to: "Vercel Pro", amount: "-$20.00", status: "pending", date: "Jan 29, 2026" },
  { id: "TXN-005", to: "Invoice #1042", amount: "+$3,200.00", status: "pending", date: "Jan 28, 2026" },
];
        ...
        <Card className="lg:col-span-3">
          ...
          <CardContent className="space-y-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-xs text-muted-foreground">3 beneficiaries</span>
            </div>
          </CardContent>
        </Card>
      </div>
            ...
            <TableBody>
              {transactions.map((tx) => (
                <TableRow key={tx.id}>
                  ...
                  <TableCell className={`text-right font-medium ${tx.amount.startsWith("+") ? "text-primary" : ""}`}>
                    {tx.amount}
                  </TableCell>
                </TableRow>
              ))}
