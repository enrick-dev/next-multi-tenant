...
const projects = [
  ...
  {
    name: "Dashboard Widgets — SaaS Inc",
    progress: 15,
    status: "new",
    tasks: "2/14",
    due: "Mar 20",
...
const timeEntries = [
  {
    ...
    task: "Color palette exploration",
    hours: "3.5h",
    person: "RM",
  },
  {
    project: "Mobile App UI",
    task: "Wireframe iteration",
    hours: "2.0h",
    person: "SK",
  },
  {
